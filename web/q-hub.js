...
window.Q_IntegrationHub = {
    ...
    injectCSS: function() {
        ...
        style.innerHTML = `
            ...
            .q-hub-box { width: 90vw; max-width: 500px; max-height: 85vh; overflow-y: auto; background: rgba(5, 8, 15, 0.95); border: 1px solid var(--theme-main, #00f0ff); border-radius: 8px; padding: 25px; box-sizing: border-box; box-shadow: 0 20px 50px rgba(0,0,0,0.9); display: flex; flex-direction: column; gap: 15px; color: #fff; font-family: 'JetBrains Mono', monospace; pointer-events: auto; }
            ...
            .q-hub-box::-webkit-scrollbar-thumb { background: var(--theme-main, #00f0ff); border-radius: 3px; }
            ...
            .q-ctrl-btn { background: transparent; border: 1px solid var(--theme-main, #F4D068); color: var(--theme-main, #F4D068); padding: 8px 14px; cursor: pointer; font-family: 'Orbitron'; font-size: 0.65rem; font-weight: 700; border-radius: 6px; transition: 0.3s; letter-spacing: 1px; white-space: nowrap; pointer-events: auto; }
            .q-ctrl-btn:hover { background: rgba(255,255,255,0.1); color: #fff; }
            .q-ctrl-btn.active { background: var(--theme-main, #F4D068); color: #000; }
            .q-scrubber { flex-grow: 1; accent-color: var(--theme-main, #F4D068); cursor: pointer; height: 4px; -webkit-appearance: none; margin: 0 10px; border-radius: 2px; background: rgba(255,255,255,0.1); pointer-events: auto; }
            .q-scrubber::-webkit-slider-thumb { -webkit-appearance: none; height: 22px; width: 22px; background: var(--theme-main, #F4D068); clip-path: polygon(50% 0%, 60% 40%, 100% 50%, 60% 60%, 50% 100%, 40% 60%, 0% 50%, 40% 40%); cursor: grab; pointer-events: auto; }
            ...
            .hub-tier-row:hover { border-color: var(--theme-main, #00f0ff); box-shadow: inset 0 0 10px rgba(0, 240, 255, 0.1); }
